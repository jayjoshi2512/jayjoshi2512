...
<!-- Header Banner -->
<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=12&height=200&section=header&text=Jay%20Joshi&fontSize=80&fontAlignY=35&animation=twinkling&fontColor=fff"/>
...
<p align="center">
  <img src="https://komarev.com/ghpvc/?username=jayjoshi2512&label=Profile%20Views&color=brightgreen&style=for-the-badge" alt="Profile views" />
  <img src="https://img.shields.io/github/followers/jayjoshi2512?label=Followers&style=for-the-badge&color=blue" alt="GitHub followers" />
</p>
...
|:-------------:|:------------------:|:-----------------:|:------------:|
| **🎯 Taskk** | Notion-style productivity web app with modern UI | `MERN` + `Shadcn/ui` | [![Live Demo](https://img.shields.io/badge/🌐_Live_Demo-success?style=for-the-badge)](https://taskk-1-16pw.onrender.com/) [![GitHub](https://img.shields.io/badge/📂_Code-blue?style=for-the-badge)](https://github.com/jayjoshi2512/taskk) |
| **🏥 Medi-Sense** | AI-powered health diagnostic platform with 4 ML models | `React` + `Flask` + `ML` | [![GitHub](https://img.shields.io/badge/📂_Code-blue?style=for-the-badge)](https://github.com/jayjoshi2512/Medi-Sense) |
| **📱 QrAttendify** | Smart attendance system with mobile app & web dashboard | `Flutter` + `React` + `PHP` | [![Live Demo](https://img.shields.io/badge/🌐_Live_Demo-success?style=for-the-badge)](https://www.qrqr.miwtindia.com) |

</div>

---

## <img src="https://media.giphy.com/media/26tn33aiTi1jkl6H6/giphy.gif" width="35"> **Hackathon Journey**
